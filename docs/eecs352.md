...
[Annie Chu](https://anniejchu.github.io) 1-2pm Mondays in Mudd 3202 or [by appointment](mailto:anniechu@u.northwestern.edu)
...
2. Class participation - in-class paper reading activities and initial + mid check ins
...
| Week | Date        | Topic                                                                                                                                                                                                           | In Class Activity | Assignment Due                                                                                                                             |                  Points |
| ---: | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------: |
|    1 | Mon June 22 | Course intro, [Recording Basics](eecs352stuff/CS352-topic1-recording-basics.pdf) |Meeting Sign Up: [LINK](https://docs.google.com/spreadsheets/d/1v5VeqGpUOxIp7wP0vM-gzaabNCpfUQZKOO77V-HjFvY/edit?usp=sharing); [Audio 101: Who Let the Dogs Out?](eecs352stuff/1_audio-101.zip) |                                                                                                                                            |                         |
...
|    3 | Wed July 8  | Advanced Filtering: [Source Separation w/ REPET](eecs352stuff/CS352-topic10-REPET-SIM.pdf) | [Paper Reading Activity](https://colinraffel.com/blog/role-playing-seminar.html)   | Read REPET paper before class  | 5 (of 15) |
...
|    6 | Mon Aug 3   | [Embeddings](eecs352stuff/CS352-embeddings.pdf) + Project Proposals  | [Embeddings Notebook](eecs352stuff/NUCS352_clap_embeddings_notebook.zip) |                                                                                                                                            |                         |
