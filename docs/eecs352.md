...
|----:|-------------|-----------------------------------|-----------------|------:|
|1    | Mon June 22   | Course intro, [Recording Basics](eecs352stuff/CS352-topic1-recording-basics.pdf), Meeting Sign Up [link](https://docs.google.com/spreadsheets/d/1v5VeqGpUOxIp7wP0vM-gzaabNCpfUQZKOO77V-HjFvY/edit?usp=sharing) |  |   |    
...
|3    | Wed July 8  | Advanced Filtering: [Source Separation w/ REPET](eecs352stuff/CS352-topic10-REPET-SIM.pdf) |  [Paper Reading Activity](https://colinraffel.com/blog/role-playing-seminar.html)      |   5 (of 15)   |    
...
|5    | Mon July 27   | Midterm & Final Project Overview | Midterm Test + Meeting |   10 + 5 (of 15)   | 
|6    | Wed July 29   | [Deep Learning](eecs352stuff/CS352-topic12-deep-nets.pdf) & [Autoencoders](eecs352stuff/DL_Autoencoders.pdf)   |   | |    
|6    | Mon Aug 3  | [Embeddings](eecs352stuff/CS352-embeddings.pdf) & [Embeddings Notebook](eecs352stuff/NUCS352_clap_embeddings_notebook.zip) + Project Proposals |    |      |  
