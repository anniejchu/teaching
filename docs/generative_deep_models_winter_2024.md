...
|----:|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|------------------------|
|     | Mon Jan 8     | [Autoregressive language models](https://interactiveaudiolab.github.io/course-deep-learning/slides/DL_attention_networks.pdf)                   | Pardo           |                        |
|     |               | [Attention](https://interactiveaudiolab.github.io/course-deep-learning/slides/DL_attention_networks.pdf)                                        | Pardo           |                        |
...
|     |               |                                                                                                                                                 |                 |                        |
|     | Mon Jan 22    | Embeddings: [The Illustrated Word2Vec](https://jalammar.github.io/illustrated-word2vec/)                                                        | Pardo           |                        |
|     |               | Positional Encoding                                                                                                                             | Pardo           |                        |
|     |               | [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://arxiv.org/pdf/1810.04805.pdf)                        | Alec P.         | Shang W. & Walker D.   |
|     | Mon Jan 29    | [Allocating Ownership Rights in Computer Generated Works](https://www.law.berkeley.edu/wp-content/uploads/2024/01/Pam-Samuelson-Allocating-Ownership-Rights-in-Computer-Generated-Works.pdf)| Kelly J.    | Jon H.  & Lirika S. |
|     |               | Discussion of ethics and ownership with respect to generative models                                                                            |                 |                        |
|     | Mon Feb 5     | [The Curious Case of Neural Text Degeneration](https://arxiv.org/abs/1904.09751)                                                                | Shubham S.      | Jon H. & Simon B.      |	
|     |               | [A Watermark for Large Language Models](https://arxiv.org/pdf/2301.10226.pdf)                                                                   | Charlotte L.    | Annie C. & Kelly J.    |
|     |               | [Quantifying Memorization Across Neural Language Models](https://arxiv.org/abs/2202.07646)                                                      | Walker D.       | Shubham S. & Nathan G. |
|     | Mon Feb 12    | [Deep Reinforcement Learning: Pong from Pixels](http://karpathy.github.io/2016/05/31/rl/)                                                       | Jon H.          | Natalia D. & James A.  |
|     |               | [Deep reinforcement learning from human preferences](https://arxiv.org/abs/1706.03741)                                                          | Pardo           | Atmn P.  & Izzy H.     |
|     |               | [Training language models to follow instructions with human feedback](https://arxiv.org/pdf/2203.02155.pdf)                                     | Simon B.        | Lirika S  & Shubham S. |
|     | Mon Feb 19    | Variational Auto Encoders (VAEs)                                                                                                                | Pardo           |                        |
|     |               | [VQ-VAE: Neural Discrete Representation Learning](https://arxiv.org/abs/1711.00937)                                                             | James A.        | Adam H. & Nathan G.    |
|     |               | [An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929)                                  | Shang W.        | Charlotte L. & Alec P. |
|     | Mon Feb 26    | [Zero-Shot Text-to-Image Generation](https://arxiv.org/pdf/2102.12092.pdf)                                                         | Atmn P.         | Conor K. & James A.   & Alec P.  |
|     |               | [MaskGIT: Masked Generative Image Transformer](https://openaccess.thecvf.com/content/CVPR2022/html/Chang_MaskGIT_Masked_Generative_Image_Transformer_CVPR_2022_paper.html)  | Natalia D. & Lirika S. | Izzy H. & Simon B.   |
|     |               | [Vampnet: Music Generation via Masked Acoustic Token Modeling](https://arxiv.org/abs/2307.04686)                                                | Annie C.        | Walker D. & Negar K.   |
|     | Mon March 4   | [MusicLM: Generating Music From Text](https://google-research.github.io/seanet/musiclm/examples/)                                               | Izzy H.         | Annie C. & Natalia D.  |
|     |               | [LORA: Low-rank Adaptation of Large Language Models](https://arxiv.org/pdf/2106.09685.pdf)                                                      | Nathan G.       | Adam H.  & Conor K.    |
|     |               | Diffusion/Score models                                                                                                                          | Pardo           |                        |
|     | Mon March 11  | [Learning Transferable Visual Models From Natural Language Supervision](https://arxiv.org/abs/2103.00020)                                       | Adam H.         | Charlotte L. & Shang W.|
|     |               | [GLIDE: Towards Photorealistic Image Generation and Editing with Text-Guided Diffusion Models](https://arxiv.org/abs/2112.10741)                | Conor K.        | Kelly J. & Atmn P.     |
...
<li>10 points: Updated slides, in response to feedback from presentation </li>
</ul>
...
1. [Learning Transferable Visual Models From Natural Language Supervision](https://arxiv.org/pdf/2103.00020.pdf): This describes how the original DALL-E selects which of the many images it generates should be shown to the user.
...
1. [Consistency Trajectory Models](https://consistencytrajectorymodel.github.io/CTM/). For single-step diffusion model sampling, our new model, Consistency Trajectory Model, achieves SOTA on CIFAR-10 (FID 1.73) and ImageNet 64x64 (FID 1.92). CTM offers diverse sampling options and balances computational budget with sample fidelity effectively.
